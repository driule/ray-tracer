...
Scene::Scene()
{
	...
	this->primitives[1] = new Sphere(redMaterial, vec3(-3.5, -3.5, 5), 2);
	//this->primitives[2] = new Sphere(redMaterial, vec3(0, 3, 5), 1);
	//this->primitives[3] = new Sphere(redMaterial, vec3(5, 0, 5), 3);
	//this->primitives[4] = new Sphere(redMaterial, vec3(0, 5, 5), 3);
}
